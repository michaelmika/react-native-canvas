...
const waitForFonts = require("./fonts");
...
var Canvas = (_dec = (0, _webviewBinders.webviewTarget)('canvas'), _dec2 = (0, _webviewBinders.webviewProperties)({
  width: 300,
  height: 150
}), _dec3 = (0, _webviewBinders.webviewMethods)(['toDataURL', 'waitForFonts']), _dec(_class = _dec2(_class = _dec3(_class = function (_Component) {
  function Canvas() {
    var _this;
    ...
    _this.handleLoad = function (googleFonts) {
      _this.setState({
        isLoaded: true
      });
      _this.bus.resume();
  ...
  _createClass(Canvas, [
      {
        ...
        value: function render() {
          ...
          // Replace fonts
            var htmlContent = _indexHtml.default;
            var regex = new RegExp("<link rel=\"headLinks\" *>", 'g');
          ...
          if (_reactNative.Platform.OS === 'android') {
            ...
            return _react.default.createElement(_reactNative.View, {
              ...
              onLoad: () => this.handleLoad(googleFonts),
