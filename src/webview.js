var waitForFontsFn = require("./fonts");
...
function _iterableToArray(iter) {
    if ((typeof Symbol === "function" ? typeof Symbol === "function" ? Symbol.iterator : "@@iterator" : "@@iterator") in Object(iter) || Object.prototype.toString.call(iter) === "[object Arguments]") return Array.from(iter);
}
        ...
        value: function waitForFonts(fonts) {
            return new Promise(function (resolve, reject) {
                ...
                fonts.forEach(function (fontFace) {
                    var font = new window.FontFaceObserver(fontFace);
                    let char = null;
    ...
    switch (type) {
        ...
        case 'listen':
        {
            var _ret = function () {
                ...
                for (var _iterator = types, _isArray = Array.isArray(_iterator), _i = 0, _iterator = _isArray ? _iterator : _iterator[typeof Symbol === "function" ? typeof Symbol === "function" ? Symbol.iterator : "@@iterator" : "@@iterator"]();;) {
                    var _ref2;
...
function handleIncomingMessage(e) {
    ...
    if (Array.isArray(data)) {
        for (var _iterator2 = data, _isArray2 = Array.isArray(_iterator2), _i2 = 0, _iterator2 = _isArray2 ? _iterator2 : _iterator2[typeof Symbol === "function" ? typeof Symbol === "function" ? Symbol.iterator : "@@iterator" : "@@iterator"]();;) {
            var _ref3;
